        ...
        <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-rose-50">
          ...
          <nav className="navbar fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-6 py-4">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              ...
              <BookButton className="bg-gradient-to-r from-amber-500 to-rose-500 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300">
                Book Now
              </BookButton>
            </div>
          </nav>

          {/* Hero Section (id is referenced by PageAnimations' GSAP triggers) */}
            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <div className="hero-cta flex flex-wrap gap-4">
                  <BookButton className="bg-gradient-to-r from-amber-500 to-rose-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
                    Get Started
                  </BookButton>
                  <a
                    href="#features"
          ...
          {/* Gallery Section */}
          <section id="gallery" className="py-24 px-6 bg-gradient-to-b from-transparent to-amber-50">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-5xl font-bold mb-4 bg-gradient-to-r from-amber-600 to-rose-600 bg-clip-text text-transparent">
                  Happy Moments
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="bg-gradient-to-br from-amber-500 to-rose-500 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <BookButton className="bg-white text-amber-600 px-8 py-4 rounded-full font-semibold text-lg hover:scale-105 transition-all duration-300 shadow-lg">
                    Start Free Trial
                  </BookButton>
                  <a
                    href="#contact"
